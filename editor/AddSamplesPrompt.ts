...
export class AddSamplesPrompt {
    ...
    private readonly _instructionsLink: HTMLAnchorElement = a({ href: "#" }, "Here's more information and some instructions on how to use custom samples in AxoBox.");
    ...
    private readonly _instructionsArea: HTMLDivElement = div(
        ...
        div({ style: "margin-top: 0.5em; margin-bottom: 0.5em;" },
            "In AxoBox, custom samples are loaded from arbitrary URLs.",
        ),
